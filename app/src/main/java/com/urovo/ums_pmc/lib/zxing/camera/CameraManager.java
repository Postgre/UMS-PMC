...
package com.urovo.ums_pmc.lib.zxing.camera;
...
public final class CameraManager {
	...
	public synchronized void openDriver(SurfaceHolder holder) throws IOException {
		...
		try {
			...
			// intCameraOrientation(theCamera, context);
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int height = findDesiredDimensionInRange(screenResolution.y, MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT) * 4 / 6;
